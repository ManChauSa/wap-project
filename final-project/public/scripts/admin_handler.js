function view(obj) {
    ...
    $(".nav_pane div").removeClass("active");
...
function toInput(obj) {
    let inputText = $(obj)
        ...
        .replace('"', "&quot");
    $(obj).before(
        "<input style='height: 40px;width: 500px;' type='text' name='" +
        $(obj).attr("name") +
        "' onmouseleave='toData(this)' value='" +
        inputText +
        "'>"
    );
    $(obj).remove();
...
function saveMenu(obj) {
    ...
    if (productId === "new") {
        let type = parent
            .children($("div[name='attributes']"))
            .children("select[name='food_type']")
            .val();
        let body = {
            type: type,
            ...
            title: parent
                .children("div[name='attributes']")
                .children("div[name='myTitle']")
                .children("div[name='title']")
                .html()
                .trim(),
            description: parent
                .children("div[name='attributes']")
                .children("div[name='myDescription']")
                .children("div[name='description']")
                .html()
                .trim(),
            price: parseFloat(
                parent
                .children("div[name='attributes']")
                .children("div[name='myPrice']")
                .children("div[name='price']")
                .html()
                .trim()
            ),
            isPopular: false,
...
function generateNewMenu() {
    ...
    <div name="attributes">
        ...
        <div class="myField" name="myTitle">
            <label>Title: </label>
            &nbsp;
            <div ondblclick="toInput(this)" name="title">Default Title</div>
        </div>

        <div class="myField" name="myDescription">
        ...
        <div class="myField" name="myPrice">
            <label>Price: </label>
            &nbsp;
            <div ondblclick="toInput(this)" name="price">0 $</div>
        </div>
        <br />
        <button onclick="saveMenu(this)" class="btn-save">Save</button>
    </div>
</div>`;
